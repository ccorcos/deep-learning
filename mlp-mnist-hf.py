...
print "loading data"
gradient_dataset = SequenceDataset(mnist[0], batch_size=None, number_batches=500)
cg_dataset = SequenceDataset(mnist[0], batch_size=None, number_batches=100)
valid_dataset = SequenceDataset(mnist[1], batch_size=None, number_batches=100)
