...
def train_lstm(
    ...
    emb = Wemb[x.flatten()].reshape([n_timesteps, n_samples, dim_proj])

    proj = lstm_layer(tparams, emb, options, 'lstm'='lstm', mask=mask)
    ...
    def _step(m_, x_, h_, c_):
        preact = tensor.dot(h_, tparams[_p('lstm', 'U')])
        preact += x_
        preact += tparams[_p('lstm', 'b')]
    ...
    emb = (tensor.dot(emb, tparams[_p('lstm', 'W')]) +
                   tparams[_p('lstm', 'b')])
