...
def sgdem(dataset=None,
    ...
    inputs are inputs to the computational graph. this included the outputs. The order of the list
    must be the same as the order in the dataset.
    """
